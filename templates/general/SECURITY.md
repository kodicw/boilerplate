...
- Vulnerabilities in system configuration templates (e.g., NixOS modules, Dockerfiles, Compose files).
- Insecure defaults or privilege escalation paths in infrastructure-as-code.
- Exposed secrets or insecure secret handling patterns in templates.
- Flaws in the `create-project` CLI that could lead to insecure project initialization.
